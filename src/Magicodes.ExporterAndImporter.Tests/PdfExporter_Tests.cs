...
namespace Magicodes.ExporterAndImporter.Tests
{
    public class PdfExporter_Tests
    {
        ...
        {
            var tplPath = Path.Combine(Directory.GetCurrentDirectory(), "TestFiles", "ExportTemplates", "batchReceipt.cshtml");
            var tpl = File.ReadAllText(tplPath);
            var exporter = new PdfExporter();
            ...
            input.ReceiptInfoInputs = new System.Collections.Generic.List<BatchReceiptInfoDto>();
            for (int i = 0; i < 50; i++)
            {
                input.ReceiptInfoInputs.Add(new BatchReceiptInfoDto()
                {
        ...
        public async Task BathExportPortraitReceipt_Test()
        {
            ...
            var tpl = File.ReadAllText(tplPath);
            var exporter = new PdfExporter();
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), nameof(BathExportPortraitReceipt_Test) + ".pdf");
            if (File.Exists(filePath)) File.Delete(filePath);
            ...
            var input = new BatchPortraitReceiptInfoInput()
            {
                ...
                SealUrl = @"data:image/jpeg;base64,",
                LogoUrl = @"data:image/png;base64,",
                ReceiptInfoInputs = new System.Collections.Generic.List<BatchPortraitReceiptInfoDto>()
            };
