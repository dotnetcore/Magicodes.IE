...
namespace OfficeOpenXml.ConditionalFormatting
{
    ...
    internal static class ExcelConditionalFormattingConstants
    {
        ...
        {
            internal static readonly Color CfvoLowValue = Color.FromRgba(0xFF, 0xF8, 0x69, 0x6B);
            internal static readonly Color CfvoMiddleValue = Color.FromRgba(0xFF, 0xFF, 0xEB, 0x84);
            internal static readonly Color CfvoHighValue = Color.FromRgba(0xFF, 0x63, 0xBE, 0x7B);
        }
        #endregion Colors
    }
}