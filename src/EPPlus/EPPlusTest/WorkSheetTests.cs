    ...
    public class WorkSheetTest : TestBase
    {
        ...
        public void ReadWorkSheet()
        {
            ...
            using (ExcelPackage pck = new ExcelPackage(instream))
            {
                ...
                Assert.AreEqual(ws.Cells["T20"].GetValue<string>(), 0.39618055555555554.ToString(CultureInfo.CurrentCulture));
                Assert.AreEqual(ws.Cells["T20"].GetValue<int>(), 0);
                Assert.AreEqual(ws.Cells["T20"].GetValue<int?>(), 0);
                Assert.AreEqual(ws.Cells["T20"].GetValue<double>(), 0.39618055555555554);
                Assert.AreEqual(ws.Cells["T20"].GetValue<double?>(), 0.39618055555555554);
                ...
                Assert.AreEqual(ws.Cells["T24"].GetValue<string>(), 1.3961805555555555.ToString(CultureInfo.CurrentCulture));
                Assert.AreEqual(ws.Cells["T24"].GetValue<int>(), 1);
                Assert.AreEqual(ws.Cells["T24"].GetValue<int?>(), 1);
                Assert.AreEqual(ws.Cells["T24"].GetValue<double>(), 1.3961805555555555);
                Assert.AreEqual(ws.Cells["T24"].GetValue<double?>(), 1.3961805555555555);
        ...
        {
            DateFunctionsWorkWithDifferentCultureDateFormats("en-US", "1/15/2014");
        }

        private void DateFunctionsWorkWithDifferentCultureDateFormats(string culture= "en-GB", string date= "15/1/2014")
        {
        ...
        {
            DateFunctionsWorkWithDifferentCultureDateFormats("en-GB", "15/1/2014");
        }
