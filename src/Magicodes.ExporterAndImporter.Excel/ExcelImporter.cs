...
namespace Magicodes.ExporterAndImporter.Excel
{
    ...
    public class ExcelImporter : IImporter
    {
        ...
        /// <returns></returns>
        public bool OutputBussinessErrorData<T>(string filePath, List<DataRowErrorInfo> bussinessErrorDataList, out string errorDataFilePath) where T : class, new()
        {
            using (var importer = new ImportHelper<T>(filePath, null))
            {
                return importer.OutputBussinessErrorData(bussinessErrorDataList, out errorDataFilePath);
            }
        }
        /// <summary>
        /// 导入多个Sheet数据
